 ...
 * @since 1.5.4
 */
function bd_get_products_name($product)
{
 ...
 * @since 1.5.4
 */
function bd_get_cart_remove_url($cart_item_key)
{
 ...
 * @since 1.5.4
 */
function bd_get_formatted_cart_item_data($cart_item, $flat = false)
{
...
function bd_price_discounted($price, $discount)
{
