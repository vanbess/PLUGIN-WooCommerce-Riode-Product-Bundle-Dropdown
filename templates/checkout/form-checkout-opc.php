...
<form name="checkout" method="post" class="bd_checkout checkout woocommerce-checkout <?php echo esc_attr($wrapper_classes); ?>" action="<?php echo esc_url(wc_get_checkout_url()); ?>" enctype="multipart/form-data">
	...
	<div class="row pt-0 <?php echo esc_attr($row_classes); ?>">
		<div class="col customer_info <?php echo esc_attr($main_classes); ?> large-7">
					...
					<div class="clear">
						<div class="woocommerce-billing-fields">
							<?php if (wc_ship_to_billing_address_only() && WC()->cart->needs_shipping()) : ?>
								...
								<h3 class="bd_checkout_title"><?php esc_html_e('Customer Information', 'bd'); ?></h3>
			...
			<?php
			// BD custom show form addon product
			do_action('bd_addon_product');
			?>
				...
				<div class="is-sticky-column">
					...
					<div class="col-inner <?php echo esc_attr($sidebar_classes); ?>">
						<div class="checkout-sidebar sm-touch-scroll">
							<h3 id="order_review_heading" class="bd_checkout_title"><?php esc_html_e('Payment Option', 'bd'); ?></h3>
